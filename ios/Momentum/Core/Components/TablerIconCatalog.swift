//
// TablerIcons.swift
// Auto-generated from tabler-icons v3.36.1
...
/// Tabler outline icons. Use with the "tabler-icons" font.
...
extension TablerIconOutline {
    /// The icon name in kebab-case (e.g. "arrow-left")
...
extension Text {
    /// Create a Text view displaying a Tabler outline icon
    public init(_ icon: TablerIconOutline) {
        self.init(icon.rawValue)
    }

    /// Create a Text view displaying a Tabler filled icon
    public init(_ icon: TablerIconFilled) {
        self.init(icon.rawValue)
    }
}

extension Label where Title == Text, Icon == Text {
    /// Create a Label with a Tabler outline icon
    public init(_ titleKey: LocalizedStringKey, tablerIcon: TablerIconOutline) {
        self.init { Text(titleKey) } icon: { Text(tablerIcon) }
    }

    /// Create a Label with a Tabler filled icon
    public init(_ titleKey: LocalizedStringKey, tablerIcon: TablerIconFilled) {
        self.init { Text(titleKey) } icon: { Text(tablerIcon) }
    }
}
#endif
...
extension UIFont {
    /// Load the Tabler Icons outline font
    public static func tablerIcons(size: CGFloat) -> UIFont {
        UIFont(name: "tabler-icons", size: size) ?? .systemFont(ofSize: size)
    }

    /// Load the Tabler Icons filled font
    public static func tablerIconsFilled(size: CGFloat) -> UIFont {
        UIFont(name: "tabler-icons-filled", size: size) ?? .systemFont(ofSize: size)
    }
}
#endif
