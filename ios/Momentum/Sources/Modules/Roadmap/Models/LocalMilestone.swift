...
final class LocalMilestone {
    ...
    init(id: String, goalId: String, orderIndex: Int, title: String, milestoneDescription: String, expectedOutcome: String, targetMonth: Int, targetWeek: Int = 0, isMonthlyCheckpoint: Bool = false, createdAt: String) {
        self.id = id
        self.goalId = goalId
