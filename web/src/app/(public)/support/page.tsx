...
export function generateMetadata(): Metadata {
  return {
    ...
    description:
      "Get help with the Momentum app. Find answers to common questions or reach out to our support team.",
    openGraph: {
      title: "Support - Momentum",
      description:
        "Get help with the Momentum app. Find answers to common questions or reach out to our support team.",
...
const faqs = [
  {
    ...
    answer:
      "Momentum is an AI-powered personal coaching app that helps you turn one big goal into a clear, actionable plan. It creates a personalized roadmap with milestones, weekly plans, and daily tasks — so you always know what to do next.",
  },
  {
    question: "How does the AI coach work?",
    answer:
      "When you set your goal, Momentum generates a personalized roadmap broken into milestones. Each week, your AI coach creates a focused weekly plan with daily tasks tailored to your progress. The coach adapts as you move forward, keeping you on track with structure and support.",
  },
  {
    question: "What coaches are available?",
    answer:
      "Momentum offers four distinct coaching personalities. The Motivator brings high energy and encouragement. Zen focuses on mindfulness and sustainable progress. Strict holds you accountable with direct, no-nonsense guidance. Buddy is your friendly, approachable companion who makes the journey feel lighter.",
  },
  {
    question: "How do I cancel my subscription?",
    answer:
      "You can manage or cancel your subscription through your iPhone's Settings app. Go to Settings > your name > Subscriptions, find Momentum, and select Cancel Subscription.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "You can reach us anytime at support@momentum-ai.app. We typically respond within 24 hours.",
  },
];
  ...
  return (
    <div className="space-y-16">
      ...
      <section className="text-center">
        ...
        <p className="mt-3 text-[#4a4a4a]">
          Ready to turn your ambition into a clear path? Get Momentum on the App
          Store.
        </p>
